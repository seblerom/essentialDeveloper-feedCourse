...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view1?.isShowingImageLoadingIndicator, true, "Expected no loading indicator state change for second view once first image loading completed with error")
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view0?.renderedImage, imageData0, "Expected image for first view oncer first image loading completes successfully")
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        let invalidImageData = Data("invalida image data".utf8)
    ...
    func test_feedImageViewRetryButton_retriesImageLoad() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.imageURL, image1.imageURL, image0.imageURL], "Expected third image URL request after frist view retry action")
        
        view1?.simulateRetryAction()
        XCTAssertEqual(loader.loadedImageURLs, [image0.imageURL, image1.imageURL, image0.imageURL, image1.imageURL], "Expected fourth image URL requests after second view retry action")
    }
    ...
    func test_feedImageView_cancelsImageURLPreloadingWhenNotNearVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.imageURL, image1.imageURL], "Expected second cancelled image URL request once second image is near not visible anymore")
    }
}
